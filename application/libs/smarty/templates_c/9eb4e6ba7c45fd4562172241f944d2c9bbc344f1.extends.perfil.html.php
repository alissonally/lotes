<?php /* Smarty version Smarty-3.1.13, created on 2016-11-19 18:39:50
         compiled from "/var/www/dev/loteamento/application/views/user/perfil.html" */ ?>
<?php /*%%SmartyHeaderCode:20388274515830ab8ecfcad3-22723746%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9eb4e6ba7c45fd4562172241f944d2c9bbc344f1' => 
    array (
      0 => '/var/www/dev/loteamento/application/views/user/perfil.html',
      1 => 1479587974,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '20388274515830ab8ecfcad3-22723746',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5830ab8ed6aed4_56128572',
  'variables' => 
  array (
    'aplication' => 0,
    'is_logged' => 0,
...
<?php if ($_valid && !is_callable('content_5830ab8ed6aed4_56128572')) {function content_5830ab8ed6aed4_56128572($_smarty_tpl) {?><!doctype html>
<html lang="pt-br">
  <head>
...
logo.png" alt="">
 ...
 <br>
            Nivel: <?php echo Estatico::nivel($_smarty_tpl->tpl_vars['user']->value->nivel);?>

        </address>

        <?php if ($_smarty_tpl->tpl_vars['user']->value->nivel==Estatico::CORRETOR){?>
            <address>
                CRECI: <?php echo $_smarty_tpl->tpl_vars['user']->value->corretor->creci;?>
 <br>
                Coordenador: <?php echo $_smarty_tpl->tpl_vars['user']->value->corretor->coordenador;?>
<br>
                Imobiliária: <?php echo $_smarty_tpl->tpl_vars['user']->value->corretor->imobiliaria;?>
<br>
            </address>
            <a href="<?php echo $_smarty_tpl->tpl_vars['aplication']->value['app'];?>
corretor/edit/<?php echo $_smarty_tpl->tpl_vars['user']->value->corretor->id;?>
" class="btn btn-success">Editar Informações do corretor</a>
        <?php }?>
    </div>
    <div class="col-md-8">
        <form class="form-horizontal" role="form" action="<?php echo $_smarty_tpl->tpl_vars['aplication']->value['app'];?>
usuario/create_perfil" method="POST">
